<!-- source: https://wiki.hypr.land/configuring/core/advanced-configuration/using-hyprctl -->
...
See [Config options](../../config-options) for sections and options you can use.
